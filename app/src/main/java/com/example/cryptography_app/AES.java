        ...
        enc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    //make a toast here to say encrypted successfully
        ...
        dec.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    inptext = input_text.getText().toString();
                    // pwdtext = password_text.getText().toString();
                    outputstring = decrypt(inptext, pwdtext);// outputstring was there in place of inputtext
                    output_text.setText(outputstring);
                    //make a toast her e to say decrypted successfully
